...
import BuyTicketFlow from '../../components/events/BuyTicketFlow';
...
const EventDetailPage: React.FC = () => {
  ...
  const [showBuyTicketFlow, setShowBuyTicketFlow] = useState(false);
  ...
  // Update the image URL to a high-quality festival image
  const festivalImage = "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&q=80";

  return (
    <div className="min-h-screen bg-gray-50 pt-[64px]">
      {/* Breadcrumb - Removed background and adjusted padding */}
      ...
      <AnimatePresence>
        {showBuyTicketFlow && (
          <BuyTicketFlow
            ...
            onClose={() => setShowBuyTicketFlow(false)}
            onSubmit={() => {
